...
/*   Updated: 2023/02/17 23:42:04 by root             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{  
    ...
    class map
    {
        ...
        mapped_type& at(const key_type &key)
        {
            ...
            tmp = NULL;
            tmp = this->find(key);
            if (!tmp || (!tmp->node->left && !tmp->node->right))
                throw (std::out_of_range("map"));
            return (tmp->node->value.second);
        }
        ...
        /***** Capacity *****/
        /* empty */
        bool empty() const { return (this->_tree.isEmpty()); }
        ...
        /* find */
        iterator find(const key_type &key) { return (iterator(this->_tree.search(ft::make_pair(key, mapped_type())))); }
        const_iterator find(const key_type &key) const { return (const_iterator(this->_tree.search(ft::make_pair(key, mapped_type())))); }
    ...
    {
        typename ft::map<Key, T, Compare, Alloc>::iterator   i;
        typename ft::map<Key, T, Compare, Alloc>::iterator   j;
